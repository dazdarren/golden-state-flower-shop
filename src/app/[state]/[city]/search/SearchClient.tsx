...
import { OCCASIONS, PRODUCT_TYPES } from '@/data/categories';
...
function SearchResultsContent({ state, city, cityName }: SearchClientProps) {
...
export default function SearchClient({ state, city, cityName }: SearchClientProps) {
  return (
    <Suspense fallback={
      ...
      <SearchResultsContent state={state} city={city} cityName={cityName} />
    </Suspense>
  );
}
